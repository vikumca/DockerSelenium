...
import com.JavaSelenium.TestFactory.core.ui.ICheckBox;
    ...
    public void check() throws FrameworkExceptions {
        try {
            if (isLoaded()) {
                ...
                Logs.error(Constants.FORMATTER + " Checkbox element: " + elementOriginalName + " click failed");
            ...
            throw new FrameworkExceptions(Constants.FORMATTER + Constants.FAILURE_METHOD_MESSAGE + " check() of Checkbox class." + fe);
        }
    }
    ...
    public boolean isChecked() throws FrameworkExceptions {
        try {
            if (isLoaded()) {
                ...
                Logs.error(Constants.FORMATTER + " Checkbox element: " + elementOriginalName + " checking failed");
                return false;
            }
        } catch (Exception fe) {
