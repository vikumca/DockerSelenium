...
public class DropDown extends Element implements IDropDown {
    ...
    public void selectByValue(String valueToBeSelected) throws FrameworkExceptions {
        try {
            ...
            Logs.error(Constants.FORMATTER + Constants.FAILURE_METHOD_MESSAGE + " selectByValue() of DropDown class");
            throw new FrameworkExceptions(Constants.FORMATTER + Constants.FAILURE_METHOD_MESSAGE + " selectByValue() of DropDown class." + fe);
        }
    }
    ...
    public void selectByVisibleText(String valueToBeSelected) throws FrameworkExceptions{
        try {
            ...
            Logs.error(Constants.FORMATTER + Constants.FAILURE_METHOD_MESSAGE + " selectByVisibleText() of DropDown class");
            throw new FrameworkExceptions(Constants.FORMATTER + Constants.FAILURE_METHOD_MESSAGE + " selectByVisibleText() of DropDown class." + fe);
        }
    }
