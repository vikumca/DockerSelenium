...
public class TextField extends Element implements ITextField {
    ...
    public void setTextWithSendKey(String text, Keys key) throws FrameworkExceptions {
        ...
        try {
            ...
            Logs.error(Constants.FORMATTER + Constants.FAILURE_METHOD_MESSAGE + " setTextWithSendKey() of TextField class");
            throw new FrameworkExceptions(Constants.FORMATTER + Constants.FAILURE_METHOD_MESSAGE + " setTextWithSendKey() of TextField class." + fe);
        }
    }
}
